...
class WebDriver:
    ...
    def open_website(self, url) -> str:
        ...
        If you don't know the URL, you can use google.com and then search for it.
    ...
    def execute_action(self, script: str) -> str:
        ...
        Always check if the element is undefined before acessing it.
        Make sure that the code won't break the webdriver if something doesn't exist or is wrong.
